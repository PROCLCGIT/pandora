// /Users/clc/Ws/Appclc/pandora/src/modulos/brief/pages/BriefDetallePageNew.jsx
...
const BriefDetallePageNew = () => {
  ...
  return (
    <div className="container mx-auto p-4 max-w-7xl">
              ...
              <tbody>
                {items.map((item) => (
                  <tr key={item.id} className="hover:bg-blue-50/40 transition-colors">
                    <td className="py-3 px-4 border-b border-blue-100/60">
                      <span className="inline-flex items-center justify-center bg-blue-100 text-blue-800 rounded-full h-8 w-8 font-medium">{item.id}</span>
                    </td>
                    <td className="py-3 px-4 border-b border-blue-100/60">
                    ...
                    <td className="py-3 px-4 border-b border-blue-100/60 font-medium text-gray-800">{item.producto}</td>
                    <td className="py-3 px-4 border-b border-blue-100/60 text-gray-600">{item.descripcion}</td>
                    <td className="py-3 px-4 border-b border-blue-100/60">{item.unidad}</td>
                    <td className="py-3 px-4 border-b border-blue-100/60 font-medium text-blue-800">{item.cantidad}</td>
                    <td className="py-3 px-4 border-b border-blue-100/60">
      ...
      {/* Botones de acción */}
      <div className="flex flex-wrap justify-end gap-3 mt-6 bg-gradient-to-r from-blue-50 to-transparent p-4 rounded-lg border border-blue-100 shadow-sm">
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="outline" className="border-blue-200 text-blue-700 hover:bg-blue-50 flex items-center shadow-sm">
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white flex items-center shadow-sm">
...
export default BriefDetallePageNew;